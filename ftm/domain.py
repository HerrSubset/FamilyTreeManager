...
class Address(object):
    ...
    #constructors
    ##################################################
    def __init__(self, street, streetNumber, zipCode, town):
        self.street = street
    ...
    ##################################################
    def toString(self):
        res = "%s %s, %s %s" %(self.street, self.streetNumber, self.zipCode, self.town)
        return res
...
class ParametersContainer(object):
    ...
    def buildArguments(self, arg):
        ...
        try:
            opts, args = getopt.getopt(arg[2:], "n:N:i:f:m:g:F:d:D:p:s:S:t:T:")
    ...
    ##################################################
    def getName(self):
        return self.getDictionaryValue("name")

    def getFamilyName(self):
        return self.getDictionaryValue("familyName")

    def getID(self):
        return self.getDictionaryValue("id")

    def getGender(self):
        return self.getDictionaryValue("gender")

    def getMotherID(self):
        return self.getDictionaryValue("motherID")

    def getFatherID(self):
        return self.getDictionaryValue("fatherID")

    def getStartDateString(self):
        return self.getDictionaryValue("startDateString")

    def getEndDateString(self):
        return self.getDictionaryValue("endDateString")

    def getSecondCommand(self):
        return self.getDictionaryValue("secondCommand")

    def getPhoneNumber(self):
        return self.getDictionaryValue("phoneNumber")

    def getCommand(self):
        return self.getDictionaryValue("command")
